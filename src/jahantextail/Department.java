...
public class Department extends javax.swing.JPanel {
    ...
    private void getData() {
        ...
        try {
            code=Integer.parseInt(deptCode.getText());
        } catch (NumberFormatException e) {
          //  JOptionPane.showMessageDialog(this, "Invalid code.");
        }
          }

    private void ShowDeptTable() {
        
         try {
            String sql_1 = "select code,name from department ORDER BY id";
            PreparedStatement st = connection.prepareStatement(sql_1);
            ResultSet rs_1 = st.executeQuery();
            deptTable.setModel(DbUtils.resultSetToTableModel(rs_1));
